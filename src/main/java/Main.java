...
public class Main {
    ...
    private static final boolean ENABLE_TORSION_SPRINGS = true;
    ...
    private static final boolean ENABLE_DAMPING = true;

    private static final double INTERVAL = 0.00001;
    private static final double WRITER_INTERVAL = 0.0166666; //A 60 FPS es RT
    ...
    public static void main(String[] args) throws IOException {
        ...
        try {
            String baseFilename = String.format("W=%d_H=%d_STEP=%g_WSTEP=%g_GRAV=%b_DAMPING=%b", WIDTH, HEIGHT, INTERVAL, WRITER_INTERVAL, ENABLE_GRAVITY, ENABLE_DAMPING);
        ...
        parameters.setWidth(WIDTH)
                ...
                .setDamping(ENABLE_DAMPING)
                .setGravityEnabled(ENABLE_GRAVITY)
                .setViscousDamping(0.025)
                .setTorsionSpringsEnabled(ENABLE_TORSION_SPRINGS);
